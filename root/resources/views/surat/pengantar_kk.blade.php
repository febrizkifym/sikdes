...
<div class="a4wrapper">
    <div class="margin">
        ...
        <article>
            <div class="row">
                <div class="col-12">
                    <span class="nomor-surat" style="text-decoration: underline">SURAT PENGANTAR</span>
            ...
            <div class="row">
                <div class="col-12">
                    <table class="data" style="margin-left:auto;margin-right:auto">
                        <tr>
                            <td colspan="2">Yang bertanda tangan dibawah ini Kepala Desa Bukit Aren Kecamatan Pulubala Kabupaten Gorontalo, Menerangkan bahwa:</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="">: {{$data->penduduk->nik}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Jenis Kelamin</td>
                            <td class="">: {{$data->penduduk->jk}}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <!--  -->
                        <tr>
                            <td>Adalah benar warga/penduduk kami yang bermaksud akan membuat:</td><td></td>
                        </tr>
                        <tr>
                            <td class="kiri">a. Kartu Tanda Penduduk (KTP)</td>
                        </tr>
                        <tr>
                            <td class="kiri">b. Kartu Keluarga (KK)</td>
                        </tr>
                        <tr>
                            <td colspan="2">Guna persyaratan/keperluan :</td>
                        </tr>
                        <tr>
                            <td class="kiri">{{$data->keterangan}}</td>
                        </tr>
                        <tr>
                            <td colspan="2">Demikian surat pengantar ini kami buat dan kepada yang berkepentingan agar maklum dan untuk dipergunakan sebagai mana mestinya.</td>
                        </tr>
                        <tr>
                            <td></td>
                        </tr>
        ...
        <footer style="display: flex; justify-content: flex-end;margin-left:300px;margin-top:5cm">
