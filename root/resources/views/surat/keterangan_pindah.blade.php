...
<div class="a4wrapper">
    <div class="margin">
        ...
        <article>
            <div class="row">
                <div class="col-12">
                    <span class="nomor-surat" style="text-decoration: underline">SURAT KETERANGAN PINDAH</span>
                ...
                <div class="col-12">
                    <table class="data" style="margin-left:auto;margin-right:auto">
                        ...
                        <tr>
                            ...
                            <td class="">: {{$agama->agama}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Status Perkawinan</td>
                            <td class="">: {{$data->penduduk->status==1?'Kawin':'Belum Kawin'}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Alamat</td>
                            <td class="">: {{$data->penduduk->alamat}}
                            </td>
                        </tr>
                        <!--  -->
                        <tr>
                            <td>Tujuan Pindah ke:</td><td></td>
                        </tr>
                        <tr>
                            <td class="kiri">Dusun</td>
                            <td class="">: {{$data->dusun}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Desa</td>
                            <td class="">: {{$data->desa}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Kecamatan</td>
                            <td class="">: {{$data->kecamatan}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Kabupaten</td>
                            <td class="">: {{$data->kabupaten}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Alasan Pindah</td>
                            <td class="">: {{$data->alasan}}
                            </td>
                        </tr>
                        <tr>
                            <td class="kiri">Klasifikasi Pindah</td>
                            <td class="">: {{$data->keterangan}}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">Demikian Surat Pindah ini di buat dan diberikan kepada yang bersangkutan untuk digunakan sebagaimana mestinya.</td>
                        </tr>
                    </table>
                </div>
            </div>
