...
@section('content')
                        @php
                            ...
                            $cacat = DB::table('m_cacat')->find($p->id_cacat);
                        @endphp
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><strong class="card-title">Detail Penduduk</strong></div>
            <div class="card-body">
                    ...
                    <a href="{{route('penduduk.edit',$p->id)}}"><button class="btn btn-info">Edit Data</button></a> 
